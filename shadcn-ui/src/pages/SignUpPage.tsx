        ...
        <Card className="shadow-xl border-0">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">
              Join our AI-powered selection platform
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="text-center text-sm bg-green-50 p-3 rounded-lg">
              <p className="text-green-800">✅ Registration is always successful for demo purposes</p>
            </div>
